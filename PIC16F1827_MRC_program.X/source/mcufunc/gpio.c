...
gpio_in ts_gpio_g_in_shift_0;
gpio_in ts_gpio_g_in_shift_1;
gpio_in ts_gpio_g_in_shift_2;
gpio_in ts_gpio_g_in_neutral;        /* クラッチ制御はメインマイコン側だが、各段のギヤを強制ニュートラル状態にする信号として受け取っておく */
